...
import { listEffectiveTaskHotelAssets } from "../../../../../lib/task-hotel-asset-optimization-store";
import {
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    const hotelAssets = usesCapturedMaterialFirstWorkflow(parameters.videoType) ? listEffectiveTaskHotelAssets(taskId) : [];
